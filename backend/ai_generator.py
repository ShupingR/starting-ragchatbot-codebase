...
2. **get_course_outline**: Get complete course structure, outline, and lesson list
...
- **Course outline/structure questions**: Use get_course_outline tool first, then provide complete outline
